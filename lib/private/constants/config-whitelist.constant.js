...
module.exports = [
  ...
  // Connection Options:
  'autoReconnect', 'noDelay', 'keepAlive', 'keepAliveInitialDelay', 'connectTimeoutMS',
  'socketTimeoutMS', 'family', 'reconnectTries', 'reconnectInterval', 'poolSize',
  ...
  'auto_reconnect', 'monitorCommands', 'minSize', 'useNewUrlParser',
  'useUnifiedTopology', 'localThresholdMS', 'serverSelectionTimeoutMS',
  'heartbeatFrequencyMS', 'maxPoolSize', 'minPoolSize', 'maxIdleTimeMS',
  'waitQueueTimeoutMS', 'autoEncryption', 'driverInfo', 'directConnection',
